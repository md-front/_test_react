...
class Alert extends React.Component {
  ...
  alertClickOutside(e) {
    ...
    if (alert && !alert.contains(e.target)) this.props.hideAlert(e);
  }

  closeByEsc(e) {
    if (e.key === 'Escape') this.hideAlert(e);
  }
        ...
        <div className={styles.item}>
          ...
          <ul>
            ...
            <li>
              ...
              {' '}
              - формируются из компаний, имеющих минимум одну вакансию, размещенную за заданное в фильтре количество дней
              {' '}
            ...
            <li>
              ...
              {' '}
              - формируются из компаний, имеющих минимум одну вакансию с требуемым опытом до 1 года или содержащих вакансию с кейвордами
              {' '}
